...
<%@ include file="/WEB-INF/jspf/navbar.jsp" %> <%-- Navbar'ı merkezi dosyadan çağırıyoruz --%>
...
<%-- Navbar buraya include ediliyor, stilleri style.css'den alıyor --%>
  ...
  <div class="filter-bar">
    ...
    <div class="main-search-bar">
      <form action="${pageContext.request.contextPath}/kitaplar" method="GET" style="justify-content: center; align-items: center; display: flex">
        <%-- placeholder metnini burada güncelliyoruz --%>
          ...
          <a href="${pageContext.request.contextPath}/kitapDetay?id=${kitap.bookId}" class="book-card">
            ...
            <div class="book-card-info">
              ...
              <div class="book-card-extra-info">
                  <%-- Modelinize bu alanları eklediğinizde burası çalışacaktır --%>
                  <%--
                  <span>Sayfa Sayısı: ${kitap.pageCount}</span><br>
                  <span>Basım Evi: ${kitap.publisher}</span><br>
                  <span>Çevirmen: ${kitap.translator}</span>
                  --%>
