...
<div class="auth-container">
  ...
  <form method="POST" action="${pageContext.request.contextPath}/register">
    <div class="form-group">
      <%-- Resimdeki "Full-name" alanını bizim "username" alanımız olarak kullanıyoruz --%>
    ...
    <%-- Şifre doğrulama alanı istersen eklenebilir. Şu anki RegisterServlet bunu kontrol etmiyor ama eklenebilir. --%>
    <%--
    <div class="form-group">
        <input type="password" id="confirmPassword" name="confirmPassword" class="input-glow" placeholder="Şifreyi Doğrula" required>
    </div>
    --%>
